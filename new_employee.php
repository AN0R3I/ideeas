...
<div id="main">
    ...
    <div id="page">
        ...
        <form action="new_employee.php" method="post">
            ...
            <p>Team:
                <select name="team" >
                    <?php while($team = mysqli_fetch_assoc($teamId)) { ?>
                        <option value=" <?php echo htmlentities($team["id"]);?>" > <?php echo htmlentities($team["team_name"]);?> </option>
                    <?php } ?>
                </select>
            </p>
            <p>Password:
